...
/* Mark .app ready so the page-enter animation fires.
   calendar.js overrides this timing by adding .ready only after CSV loads. */
document.addEventListener('DOMContentLoaded', () => {
  /* Defer one frame so calendar.js (if present) can take over timing */
